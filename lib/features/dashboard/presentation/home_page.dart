    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            onPressed: () => context.push('/nutrition-coach'),
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        Text(
          _formatGoal(profile?['goal'] as String?),
        ...
        if (biometrics == null)
          ...
          GridView.count(
            ...
            children: [
              _MetricCard(
                label: 'Weight',
                value: _number(biometrics['weight_kg'], ' kg'),
              ),
              _MetricCard(
                label: 'Body fat',
                value: _number(biometrics['body_fat_pct'], '%'),
              ),
              _MetricCard(
                label: 'Muscle mass',
                value: _number(biometrics['muscle_mass_kg'], ' kg'),
              ),
        ...
        _ActionCard(
          ...
          title: 'Start workout',
          subtitle: 'Open your training plan.',
        ...
        _ActionCard(
          ...
          subtitle: 'Generate a starting calorie and macro target.',
          onTap: () => context.push('/nutrition-coach'),
        ),
        const SizedBox(height: 12),
        _ActionCard(
          icon: Icons.search,
          title: 'Food database',
          subtitle: 'Search foods and add them in servings.',
        ...
        _ActionCard(
          ...
          title: 'Body metrics',
          subtitle: 'Log weight, body fat, muscle, and waist.',
        ...
        _ActionCard(
          icon: Icons.insights,
          title: 'View progress',
          subtitle: 'Review workout history and performance.',
